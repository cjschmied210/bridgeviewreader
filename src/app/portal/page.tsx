            ...
            <div className="max-w-5xl mx-auto">
                <header className="flex justify-between items-end mb-12">
                    ...
                    <div className="flex gap-4">
                        <button 
                            onClick={() => signOut()}
                            className="px-4 py-2 text-stone-600 hover:text-red-600 font-bold"
                        >
                            Sign Out
                        </button>
                        <button
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-stone-900 p-6 rounded-xl text-stone-100 shadow-lg relative overflow-hidden group cursor-pointer" onClick={() => router.push('/profile')}>
                            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                                <BookOpen size={120} />
                            </div>
                            <h2 className="text-lg font-bold mb-2 font-serif flex items-center gap-2">
                                YOUR PROFILE
                            ...
                            <p className="text-stone-400 text-sm mb-6">
                                Track your leveled skills and XP.
                            </p>

                            <div className="inline-block bg-stone-800 px-4 py-2 rounded-lg font-bold text-sm border border-stone-700 hover:bg-stone-700 transition-colors">
                                View Competence Tree
                            </div>
                        </section>
                    </div>
                </div>
