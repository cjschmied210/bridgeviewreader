...
import { BookOpen, PenTool, Lightbulb, HelpCircle, Users, MessageSquare, Send } from 'lucide-react';
...
export function ThinkingSidebar({ isFocused, kwlData, annotations = [], onAnnotationClick, isSpanish = false, role, classStream = [], onPostStream, onLikePost }: ThinkingSidebarProps) {
    // Role Tool States
                ...
                <div className="flex-1 overflow-y-auto space-y-3 pr-1 custom-scrollbar">
                    {classStream.length === 0 ? (
                        ...
                        classStream.map((post) => (
                            <div key={post.id} className="bg-white border border-stone-200 rounded-lg p-4 shadow-sm animate-in slide-in-from-bottom-2">
