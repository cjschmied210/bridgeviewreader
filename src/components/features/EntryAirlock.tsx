...
import { ArrowRight, Brain, Image as ImageIcon, Lightbulb, Search } from 'lucide-react';
...
export function EntryAirlock({ assignment, onComplete }: EntryAirlockProps) {
    const [step, setStep] = useState<1 | 2 | 3>(1); // Scavenger Hunt is step 3
